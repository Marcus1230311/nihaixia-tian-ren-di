# 知識模型 V1.5（Freeze Candidate）

> 治理狀態與變更邊界見 [`KNOWLEDGE_MODEL_V1_FREEZE.md`](./KNOWLEDGE_MODEL_V1_FREEZE.md)。1.5.0 已進入 V1 Freeze Candidate；本文件保留完整 schema、詞彙與歷次壓力測試說明。
