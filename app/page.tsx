  ...
  return (
    <>
      <section className="hero-shell">
        ...
        <p>沿著《易經》研讀路徑閱讀課程正文，也可從經典、八卦與相關條目交叉查找。每一筆整理都保留來源與清楚的內容界線。</p>
      ...
      <section className="platform-grid" aria-labelledby="model-title">
        <div><p className="kicker">研讀架構</p><h2 id="model-title">課程、經典與八卦彼此相連</h2><p>目前收錄 {lessons.length} 篇《易經》課程、1 部經典與 {trigrams.length} 個八卦條目。條目附有別名、說明、來源與可閱讀的關係標示。</p></div>
