...
export default async function LessonPage({ params }: { params: Promise<{ slug: string[] }> }) {
  ...
  const isStructuredLesson = isStructuredTianjiLesson || isStructuredRenjiLesson;
  ...
  return (
    <div className="page-shell">
      ...
      {article ? <article className="classic migrated-content" dangerouslySetInnerHTML={{ __html: article }} /> : isStructuredRenjiLesson ? <StructuredRenjiLesson lesson={lesson} relatedEntities={relatedEntities} /> : <StructuredTianjiLesson lesson={lesson} relatedEntities={relatedEntities} />}
